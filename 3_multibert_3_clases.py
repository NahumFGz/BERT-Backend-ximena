...
result_dir   =  '/content/drive/MyDrive/ResultadosEntrenamiento/Tesis_Ximena/'+ dataset_name + '_PROC'+ flg_preproc  + '_MDL'+ model + '_BLC'+ balanceo +'_TS'+ str(test_sz) + '_RS'+ str(rand_state) +'_epch' + str(num_epochs) + '_lr' + str(learning_rate) + '_BZ' + str(batch_size)
